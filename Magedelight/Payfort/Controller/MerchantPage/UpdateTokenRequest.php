 ...
 */
class UpdateTokenRequest extends \Magento\Framework\App\Action\Action
{
    ...
    const RETURNURL = 'payfort/MerchantPage/UpdateTokenResponse';
    ...
    {
        $public_hash = $this->getRequest()->getParam('public_hash');
        ...
        if (!empty($public_hash)) {
            ...
            $cardid = $cardDetails->getFirstItem()->getId();
            $signFields = [];
            ...
            $postfield['merchant_reference'] = $cardid . "_" . $merchant_reference;
