 ...
 */
class RequestVoidCommandBuilder implements BuilderInterface
{
    const VOID_AUTHORIZATION = 'VOID_AUTHORIZATION';
    ...
    /**
     * RequestVoidCommandBuilder constructor.
     * @param Config $config
    ...
    {
        $result = [
            'command' => self::VOID_AUTHORIZATION
        ];
        return $result;
    }
}
