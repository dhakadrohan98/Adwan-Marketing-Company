 ...
 */
class OrderData3dBuilder implements BuilderInterface
{
    ...
    /**
     * OrderData3dBuilder constructor.
     * @param Config $config
    ...
    public function build(array $buildSubject)
    {
        ...
        $amount = $payment->getAdditionalInformation(
            self::ORDER_AMN
        );
        ...
        if($this->payfortConfig->getDeviceFingerPrintActive()){
            $device_fingerprint = $payment->getAdditionalInformation(DataAssignObserver::DEVICEFINGERPRINT);
